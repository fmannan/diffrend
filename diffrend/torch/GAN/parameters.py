...
class Parameters():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--joint_training', action='store_true', default=False, help='use two gans')
        self.parser.add_argument('--RGBD', action='store_true', default=False, help='Use RGBD training')
