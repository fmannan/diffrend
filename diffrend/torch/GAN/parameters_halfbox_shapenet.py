...
class Parameters():
    ...
    def initialize(self):
        ...
        if username == 'dvazquez':
            ...
            default_root = './halfbox_mvfg_input2/'
            default_out = './render_samples/'
        ...
        self.parser.add_argument('--theta', nargs=2, type=float, default=[20,75], help='Angle in degrees from the z-axis.')
        ...
        self.parser.add_argument('--at', nargs=3, default=[0.01,-0.1,0], type=float, help='Camera lookat position.')
