...
class Parameters():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--enc_model_path', type=str, default=None, help='dataset root directory')
        ...
        self.parser.add_argument('--netS', default='', help="path to netD (to continue training)")
        ...
        self.parser.add_argument('--entropy_coeff', type=float, default=0.01, help='beta1 for adam. default=0.5')
        self.parser.add_argument('--n_iter', type=int, default=86201, help='number of iterations to train')
        ...
        self.parser.add_argument('--theta', nargs=2, type=float, default=[1,179], help='Angle in degrees from the z-axis.')
        self.parser.add_argument('--phi', nargs=2, type=float, default=[1,359], help='Angle in degrees from the x-axis.')
