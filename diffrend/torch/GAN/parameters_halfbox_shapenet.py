...
class Parameters():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--entropy_coeff', type=float, default=0.01, help='use unit_normal loss')
        ...
        self.parser.add_argument('--netC', default='', help="path to netD (to continue training)")
        self.parser.add_argument('--encoder_cam', action='store_true', default=False, help='Use encoding or noise for camera parameters')
