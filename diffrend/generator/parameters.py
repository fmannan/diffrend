...
class Parameters():
    ...
    def initialize(self):
        """Initialize."""
        self.parser.add_argument('--dataset', required=True, help='cifar10 | lsun | imagenet | folder | lfw | fake')
        self.parser.add_argument('--dataroot', required=True, help='path to dataset')
